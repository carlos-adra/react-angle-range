...
var AngleRange = React.forwardRef(function (_ref, ref) {
  ...
  var _useState2 = useState(_extends({}, getHandlerXY(value.from, offsetHandlerRadiusOffset), {
    angle: value.from
  })),
      fromAngleHandler = _useState2[0],
      setFromAngleHandler = _useState2[1];

  var _useState3 = useState(_extends({}, getHandlerXY(value.to, offsetHandlerRadiusOffset), {
    angle: value.to
  })),
  ...
  var centerHandlerEl = useRef(null);
  var axisCenterEl = useRef(null);
  var fromAngleHandlerEl = useRef(null);
  var toAngleHandlerEl = useRef(null);

  var _useMouse = useMouse(axisCenterEl),
      elX = _useMouse.elX,
      elY = _useMouse.elY;
  ...
  var onfromAngleHandlerMouseDown = useCallback(function (e) {
    if (isDisabled) {
      return;
    }
  ...
  var ontoAngleHandlerMouseDown = useCallback(function (e) {
    if (isDisabled) {
      return;
    }
  ...
  var getAbsoluteAngle = useCallback(function () {
  ...
  var offsetAngleOfCenter = useMemo(function () {
