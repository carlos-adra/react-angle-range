...
var HANDLER_RADIUS = 10;
var DEFAULT_HANDLER_RADIUS_OFFSET = 30;
var RADIUS = 150;
var styles = {
  root: {
    position: "relative",
...
var radiantsToDegrees = function radiantsToDegrees(radians) {
  return parseInt((radians * 180 / Math.PI).toFixed(0), 10);
};

var degreesToRadians = function degreesToRadians(degress) {
  return degress * Math.PI / 180;
};

var getCenterAngleOfRange = function getCenterAngleOfRange(from, to) {
  if (from > to) {
...
var getOffsetAngleOfRangeCenter = function getOffsetAngleOfRangeCenter(from, to) {
  if (from > to) {
    return (to + (360 - from)) / 2;
  }
...
var modulus360 = function modulus360(angle) {
  return (angle + 360) % 360;
};

var AngleRange = React__default.forwardRef(function (_ref, ref) {
  var classes = _ref.classes,
    ...
    to: 90
      ...
      _ref$limitFrom = _ref.limitFrom,
      limitFrom = _ref$limitFrom === void 0 ? null : _ref$limitFrom,
      _ref$limitTo = _ref.limitTo,
      limitTo = _ref$limitTo === void 0 ? null : _ref$limitTo,
      _ref$radius = _ref.radius,
      radius = _ref$radius === void 0 ? RADIUS : _ref$radius,
      _ref$handlerRangeRadi = _ref.handlerRangeRadiusOffset,
      handlerRangeRadiusOffset = _ref$handlerRangeRadi === void 0 ? DEFAULT_HANDLER_RADIUS_OFFSET : _ref$handlerRangeRadi,
      _ref$handlerRadius = _ref.handlerRadius,
      handlerRadius = _ref$handlerRadius === void 0 ? HANDLER_RADIUS : _ref$handlerRadius,
      _ref$offsetHandlerRad = _ref.offsetHandlerRadius,
      offsetHandlerRadius = _ref$offsetHandlerRad === void 0 ? HANDLER_RADIUS : _ref$offsetHandlerRad,
      _ref$offsetHandlerRad2 = _ref.offsetHandlerRadiusOffset,
      offsetHandlerRadiusOffset = _ref$offsetHandlerRad2 === void 0 ? HANDLER_RADIUS : _ref$offsetHandlerRad2,
      _ref$min = _ref.min,
  ...
  var getHandlerXY = React.useCallback(function (angle, handlerRadiusOffset) {
    var alpha = angle % 360;
  ...
  var _useState = React.useState(_extends({}, getHandlerXY((value.to - value.from) / 2, handlerRangeRadiusOffset), {
    angle: (value.to - value.from) / 2
  })),
      centerHandler = _useState[0],
      setCenterHandler = _useState[1];

  var _useState2 = React.useState(_extends({}, getHandlerXY(value.from, offsetHandlerRadiusOffset), {
    angle: value.from
  })),
      fromAngleHandler = _useState2[0],
      setFromAngleHandler = _useState2[1];

  var _useState3 = React.useState(_extends({}, getHandlerXY(value.to, offsetHandlerRadiusOffset), {
    angle: value.to
  })),
      toAngleHandler = _useState3[0],
      setToAngleHandler = _useState3[1];

  var _useState4 = React.useState(false),
      isCenterHandlerActive = _useState4[0],
      setIsCenterHandlerActive = _useState4[1];

  var _useState5 = React.useState(false),
      isFromAngleHandlerActive = _useState5[0],
      setIsFromAngleHandlerActive = _useState5[1];

  var _useState6 = React.useState(false),
      isToAngleHandlerActive = _useState6[0],
      setIsToAngleHandlerActive = _useState6[1];

  var centerHandlerEl = React.useRef(null);
  var axisCenterEl = React.useRef(null);
  var fromAngleHandlerEl = React.useRef(null);
  var toAngleHandlerEl = React.useRef(null);

  var _useMouse = reactUse.useMouse(axisCenterEl),
      elX = _useMouse.elX,
      elY = _useMouse.elY;
  ...
  var onCenterAngleHandlerMouseDown = React.useCallback(function (e) {
    if (isDisabled) {
      return;
    }
  ...
  var onfromAngleHandlerMouseDown = React.useCallback(function (e) {
    if (isDisabled) {
      return;
    }
  ...
  var ontoAngleHandlerMouseDown = React.useCallback(function (e) {
    if (isDisabled) {
      return;
    }
  ...
  var getAbsoluteAngle = React.useCallback(function () {
    var alpha = Math.round(elY) !== 0 ? radiantsToDegrees(Math.atan(elX / -elY)) : 90;
  ...
  }, [isDisabled, isCenterHandlerActive, isFromAngleHandlerActive, isToAngleHandlerActive, getAbsoluteAngle, min, max, getHandlerXY, handlerRangeRadiusOffset, centerHandler.angle, fromAngleHandler.angle, toAngleHandler.angle, offsetHandlerRadiusOffset, limitFrom, limitTo, onChange]);
  var offsetAngleOfCenter = React.useMemo(function () {
    return getOffsetAngleOfRangeCenter(fromAngleHandler.angle, toAngleHandler.angle);
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    style: {
      cursor: isCenterHandlerActive || isFromAngleHandlerActive || isToAngleHandlerActive ? "move" : "auto"
    }
    ...
    style: {
      transform: "translate(" + (isQuarterCircle ? "-100%, 0" : "0, -50%") + ") rotate(90deg) rotate(" + fromAngleHandler.angle + "deg)",
    ...
    className: classes.offsetsSegment,
    style: {
      transform: "translate(" + (isQuarterCircle ? "-100%, 0" : "0, -50%") + ") rotate(90deg) rotate(" + (fromAngleHandler.angle + offsetAngleOfCenter) + "deg)",
      transformOrigin: isQuarterCircle ? "100% 100%" : "50% 100%"
    }
  }, /*#__PURE__*/React__default.createElement("div", {
    className: classes.offsetsSegmentRemove,
    ...
    style: {
      ...
      left: (isQuarterCircle ? 0 : radius) + Math.max(handlerRangeRadiusOffset, 0)
    }
  }, /*#__PURE__*/React__default.createElement("div", {
    className: classes.axisCenter,
    ref: axisCenterEl
  }), /*#__PURE__*/React__default.createElement("div", {
    ref: centerHandlerEl,
    ...
    style: {
      ...
      transform: "translate(" + (centerHandler.x - handlerRadius) + "px, " + (centerHandler.y - handlerRadius) + "px)",
    ...
    style: {
      ...
      transform: "translate(" + (fromAngleHandler.x - offsetHandlerRadius) + "px, " + (fromAngleHandler.y - offsetHandlerRadius + 1) + "px) rotate(" + fromAngleHandler.angle + "deg)",
    ...
    style: {
      ...
      transform: "translate(" + toAngleHandler.x + "px, " + (toAngleHandler.y - offsetHandlerRadius + 1) + "px) rotate(" + toAngleHandler.angle + "deg)",
...
var index = injectSheet(styles)(AngleRange);
